...
os.makedirs('lplots_new_compare',exist_ok = True)
os.chdir('lplots_new_compare')
...
for vartype in variables:
    ...
    for var in variables[vartype]:
        ...
        patches       =[0]*(len(a))
        labels        =["STD (l-jets): d0=3.5mm, z0=5mm",
                        "STD+LRT (l-jets): d0=3.5mm, z0=5mm",
                        "STD (l-jets): d0=30mm, z0=30mm",
                        "STD+LRT (l-jets): d0=30mm, z0=30mm"
                        ]
