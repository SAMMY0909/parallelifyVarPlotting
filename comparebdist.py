...
os.makedirs('bplots_new_compare',exist_ok = True)
os.chdir('bplots_new_compare')
...
for vartype in variables:
    ...
    for var in variables[vartype]:
        ...
        patches       =[0]*len(a)
        labels        =["STD (b-jets): d0=3.5mm, z0=5mm",
                        "STD+LRT (b-jets): d0=3.5mm, z0=5mm",
                        "STD (b-jets): d0=30mm, z0=30mm",
                        "STD+LRT (b-jets): d0=30mm, z0=30mm"
                        ]
